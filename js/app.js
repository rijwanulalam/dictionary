...
const showData = (word) => {
  ...
  postDiv.innerHTML = `
    ...
    <p class="text-2xl text-blue-600/100 font-medium">${word.phonetic ? word.phonetic : word.phonetics[1].text}</p>
    <p class="my-5 font-bold text-2xl font-medium">${word.meanings[0].partOfSpeech} <hr></p>
    ...
    <h4 class="my-5 font-medium">Synonyms : <span class="text-blue-600/100">${word.meanings[0].synonyms[0] ? word.meanings[0].synonyms[0] : word.word}</span></h4>
    <p class="my-5 font-bold text-2xl font-medium">${word.meanings[1].partOfSpeech} <hr></p>
    <p class="my-2 font-medium">Meaning</p>
    ...
    <p class="my-5 font-medium">Source : <span class="text-blue-600/75 underline underline-offset-1">${word.sourceUrls[0]}</span></p>
  `;
